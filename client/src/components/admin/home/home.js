...
const AdminMain = () => {
  ...
  return (
    <>
      <mainm className="card-container">
        <div className="admin-card">
          <div className="item item--1">
            ...
            <span className="quantity"> View All Products </span>
            <Link to="/admin/all/products" className="text text--1">
              {" "}
              Check{" "}
            </Link>
          </div>
          <div className="item item--2">
            ...
            <span className="quantity"> Add New Product </span>
            <Link to="/admin/add/product" className="text text--2">
              {" "}
              Add{" "}
            </Link>
          </div>
          <div className="item item--3">
            ...
            <span className="quantity"> Feedbacks </span>
            <Link to="/admin/feedbacks" className="text text--3">
              {" "}
              View{" "}
            </Link>
          </div>
          <div className="item item--4">
            ...
            <span className="quantity"> Check All Users </span>
            <Link className="text text--4" to="/admin/users">
              {" "}
              Check{" "}
            </Link>
          </div>
